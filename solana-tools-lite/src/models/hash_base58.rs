...
/// A wrapper for a 32-byte hash (typically a recent blockhash).
///
/// Blockhashes are used in Solana transactions for replay protection and to define
/// the transaction's lifetime on the network.
#[derive(Clone, Copy)]
